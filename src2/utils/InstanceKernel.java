...
public class InstanceKernel extends CFCluster {
    ...
    public InstanceKernel( Instance instance, int dimensions, long timestamp , double t, int m, String label, String type) {
    ...
    public InstanceKernel( Instance instance, int dimensions, long timestamp,String label, String type) {
        super(instance, dimensions);
        // t and m default values
        this.t = 2;
        this.m = 50;
        this.LST = timestamp;
		this.SST = timestamp*timestamp;
    ...
    public InstanceKernel( InstanceKernel cluster, double t, int m, String label, String type ) {
        super(cluster);
        this.t = t;
        this.m = m;
    ...
    public void add( CFCluster other2 ) {
        InstanceKernel other = (InstanceKernel) other2;
